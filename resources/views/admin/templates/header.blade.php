        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block user-dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="{{ route('dashboard.change.password') }}"><i class="ri-wallet-2-line align-middle me-1"></i> Change Password</a>
                    ...
                    <a class="dropdown-item text-danger" href="{{route('dashboard.logout')}}"><i
